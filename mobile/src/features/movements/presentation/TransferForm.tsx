        ...
        <form className="space-y-4 px-4" onSubmit={submit}>
          ...
          <div className="grid grid-cols-1 gap-3 min-[360px]:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                value={sourceId}
                onValueChange={(value) => setSourceId(value as EntityId)}
                disabled={saving}
              >
            ...
            <div className="space-y-2">
              ...
              <Select
                value={destinationId}
                onValueChange={(value) => setDestinationId(value as EntityId)}
                disabled={saving}
              >
          ...
          <div className="grid grid-cols-1 gap-3 min-[360px]:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="transfer-amount">Monto CLP</Label>
              <Input
                id="transfer-amount"
                type="number"
                inputMode="numeric"
          ...
          <div className="space-y-2">
            <Label htmlFor="transfer-observation">Observación</Label>
            <Textarea
