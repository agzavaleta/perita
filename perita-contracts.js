...
(function (root, factory) {
  ...
  const ERROR_CODES = Object.freeze({
    ...
    WRITER_ALREADY_OWNED: 'WRITER_ALREADY_OWNED',
    WRITER_NOT_OWNED: 'WRITER_NOT_OWNED',
    WRITER_LEASE_EXPIRED: 'WRITER_LEASE_EXPIRED',
    WRITER_EPOCH_LOST: 'WRITER_EPOCH_LOST',
    ...
    LEGACY_JSON_INVALID: 'LEGACY_JSON_INVALID',
    LEGACY_STRUCTURE_INVALID: 'LEGACY_STRUCTURE_INVALID',
    LEGACY_ALIAS_MISMATCH: 'LEGACY_ALIAS_MISMATCH',
    LEGACY_RELATION_MISSING: 'LEGACY_RELATION_MISSING',
    ...
    DELETE_BACKUP_REQUIRED: 'DELETE_BACKUP_REQUIRED',
    DELETE_BACKUP_INVALID: 'DELETE_BACKUP_INVALID',
    DELETE_CONFIRMATION_INVALID: 'DELETE_CONFIRMATION_INVALID',
    DELETE_FAILED: 'DELETE_FAILED',
    INVALID_DOMAIN_RECORD: 'INVALID_DOMAIN_RECORD',
    INVALID_DOMAIN_FIELD: 'INVALID_DOMAIN_FIELD',
    DOMAIN_RELATION_MISMATCH: 'DOMAIN_RELATION_MISMATCH',
    DOMAIN_STATE_INVALID: 'DOMAIN_STATE_INVALID',
    DUPLICATE_OPERATION_REVISION: 'DUPLICATE_OPERATION_REVISION',
    DEBT_ADJUSTMENT_INVALID: 'DEBT_ADJUSTMENT_INVALID',
    FIXED_INSTANCE_NOT_ALLOWED: 'FIXED_INSTANCE_NOT_ALLOWED',
